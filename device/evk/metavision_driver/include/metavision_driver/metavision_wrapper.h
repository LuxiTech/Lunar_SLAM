...
public:
  ...
  {
    bool enabled{false};
    uint32_t lowFrequency{90};
    uint32_t highFrequency{110};
  };
  ...
  void setAntiFlicker(const bool state, const uint32_t lowFrequency, const uint32_t highFrequency);
