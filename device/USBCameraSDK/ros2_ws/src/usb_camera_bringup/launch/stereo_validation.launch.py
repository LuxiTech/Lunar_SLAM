...
def generate_launch_description():
    ...
    default_validator_params = os.path.join(
        driver_share, 'config', 'opencv_stereo_validator.yaml')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'validator_params_file', default_value=default_validator_params),
        ...
        TimerAction(
            ...
            actions=[Node(
                ...
                output='screen',
                parameters=[
                    LaunchConfiguration('validator_params_file'),
                    {'input_file': LaunchConfiguration('calibration_file')},
                ],
            )],
        ),
    ])
