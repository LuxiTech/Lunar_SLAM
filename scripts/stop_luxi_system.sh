...
readonly PROCESS_PATTERN='[/]lib[/](luxi_[^/[:space:]]+|slam_d1_bridge|rtabmap_(slam|odom|sync|viz)|realsense2_camera|imu_filter_madgwick|yesense_std_ros2|stereo_depth|hikrobot_camera_driver)[/]|[r]os2[[:space:]]+launch[[:space:]]+(luxi_[^[:space:]]+|slam_d1_bridge|lunar_realsense_bringup|lunar_d455_bringup|hik_bringup)[[:space:]]|__node:=[l]uxi_sensor_container|__node:=[s]ensor_imu_filter|__node:=[b]ase_to_sensor_tf|__node:=[h]ik_base_to_left_camera_tf|__node:=[h]ik_left_camera_to_imu_tf|[s]ensor_bringup\.launch\.py|[d]435i\.launch\.py|[d]455\.launch\.py|[s]tereo_camera_bringup\.launch\.py|[s]aved_map_navigation\.launch\.py|[r]gbd_mapping(_learned)?\.launch\.py|[s]lam_d1_bridge\.launch\.py|[l]ekiwi_web_control\.launch\.py|[w]eb_control\.launch\.py'
readonly PID_FILES=(
